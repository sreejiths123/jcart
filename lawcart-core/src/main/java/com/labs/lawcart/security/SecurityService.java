...
public class SecurityService
{
	...
	public String resetPassword(String email)
	{
		...
		if(user == null)
		{
			throw new LawCartException("Invalid email address");
		}
	...
	public void updatePassword(String email, String token, String password)
	{
		...
		if(!StringUtils.hasText(token) || !token.equals(user.getPasswordResetToken())){
			throw new LawCartException("Invalid password reset token");
		}
	...
	public Role createRole(Role role)
	{
		...
		if(roleByName != null){
			throw new LawCartException("Role "+role.getName()+" already exist");
		}
	...
	public Role updateRole(Role role)
	{
		...
		if(persistedRole == null){
			throw new LawCartException("Role "+role.getId()+" doesn't exist");
		}
	...
	public User createUser(User user)
	{
		...
		if(userByEmail != null){
			throw new LawCartException("Email "+user.getEmail()+" already in use");
		}
	...
	public User updateUser(User user)
	{
		...
		if(persistedUser == null){
			throw new LawCartException("User "+user.getId()+" doesn't exist");
		}
